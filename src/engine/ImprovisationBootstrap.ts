...
export class ImprovisationBootstrap {
   ...
   */
  private async initRenderingSystems(
    renderer: any,
    scene: any,
    camera: any,
  ): Promise<void> {
  ...
  update(deltaTime: number): void {
    ...
    if (this.config.features.networking) {
      ...
      // stateSnapshot and deltaCompression do not have update methods
      // they are data management classes called by NetworkManager
    }
